...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        'brand-base': '#F9F6F2',      // A soft, handmade paper texture
        'brand-ink': '#3A2E24',       // A deep, dark brown for text
        'brand-clay': '#B96B55',      // A warm, terracotta accent
        'brand-clay-dark': '#A05D4C',
        'brand-gold': '#C8A46E',      // A muted, antique gold
        'brand-stone': '#EAE5DE',     // A light, calming stone color
        primary: {
          50: '#fef7ee',
          100: '#fdedd6',
          200: '#fad7ac',
