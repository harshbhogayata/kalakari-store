...
const CheckoutNew = React.lazy(() => import('./pages/CheckoutNew'));
const OrderSuccess = React.lazy(() => import('./pages/OrderSuccess'));
const OrderFailed = React.lazy(() => import('./pages/OrderFailed'));
const OrdersNew = React.lazy(() => import('./pages/OrdersNew'));
const OrderDetailNew = React.lazy(() => import('./pages/OrderDetailNew'));
const FAQ = React.lazy(() => import('./pages/FAQ'));
const DiwaliCollection = React.lazy(() => import('./pages/DiwaliCollection'));
      ...
      <AuthProvider>
        <CartProvider>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="diwali" element={<RouteErrorBoundary><DiwaliCollection /></RouteErrorBoundary>} />
            ...
            <Route path="checkout" element={
              <ProtectedRoute allowedRoles={['customer']}>
                <RouteErrorBoundary><CheckoutNew /></RouteErrorBoundary>
              </ProtectedRoute>
            } />
            ...
            <Route path="orders" element={
              <ProtectedRoute allowedRoles={['customer']}>
                <RouteErrorBoundary><OrdersNew /></RouteErrorBoundary>
              </ProtectedRoute>
            } />
            <Route path="orders/:id" element={
              <ProtectedRoute allowedRoles={['customer']}>
                <RouteErrorBoundary><OrderDetailNew /></RouteErrorBoundary>
              </ProtectedRoute>
            } />
            ...
            <Route path="orders-old/:id" element={
              <ProtectedRoute allowedRoles={['customer']}>
